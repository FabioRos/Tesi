...
\newglossaryentry{CDN}{name={CDN},description={todo}}
\newglossaryentry{Breadcrumb}{name={Breadcrumb},description={TODO}}

\newglossaryentry{javascript}{name={javascript},description={TODO}}
\newglossaryentry{asseverazione}{name={asseverazione},description={TODO}}
\newglossaryentry{concern}{name={concern},description={TODO}}
...
\newglossaryentry{reverse proxy}{name={Reverse proxy}, description={TODO}}

\newglossaryentry{POJO}{name={POJO},description={TODO}}

\newglossaryentry{JavaBean}{name={JavaBean},description={TODO}}

\newglossaryentry{ERB}{name={ERB},description={TODO -> template, spiegare anche java.erb}}

\newglossaryentry{LHS}{name={LHS},description={TODO -> per spiegazione si rimanda a appendice ...}}

\newglossaryentry{RHS}{name={RHS},description={TODO -> per spiegazione si rimanda a appendice ... }}
