...
\newacronym{ASPP}{ASPP}{Addetto al Servizio di Prevenzione e Protezione}
\newacronym{AWS}{AWS}{Amazon Web Services}
\newacronym{CPI}{CPI}{Certificato Prevenzione incendi}
...
Home page del progetto: \url{http://sass-lang.com/}.
	...
	\newglossaryentry{accordion}{name={accordion},description={\hl{nuovo termine} Letteralmente sta per fisarmonica o porta a soffietto. Con il termine accordion si fa riferimento ad una struttura in grado di mostrare il contenuto d'interesse nascondendo quello non necessario. }}
...
\newglossaryentry{javascript}{name={Javascript},description={Linguaggio di scripting spesso utilizzato in pagine web per la gestione di effetti dinamici interattivi tramite funzioni invocate da eventi attivati dall'utente oppure da altri eventi.}}
